...
void timer_set2(uint32_t delay)
{
    ndelay2 = ndelay; // keep last delay
    ndelay=delay; // laser on delay
    ndelay2=fmax(0,ndelay2-ndelay); // the rest delay after laser off
}
